...
public class RandomUserAgent {
	...
	private static Map<String, String[]> uaChromeMap = new HashMap<String, String[]>();
	static {
	...
	public static String getRandomUserAgentForChrome() {
		String browser = "Ubuntu";
		String userAgents[] = uaChromeMap.get(browser);
		int index = (int) Math.floor(Math.random() * userAgents.length);

...
public class ThisRun {
	...
	private static Logger logger = Logger.getLogger(ThisRun.class.getName());
	...
	private ThisRun() {
		...
		add(KEYS.TEST_RESOURCES, getAsString("PROJECT_PATH")
				+ "/src/test/resources");
		add(KEYS.REPORT_PATH, getAsString("PROJECT_PATH") + "/reports");
		add(KEYS.FEATURE_FILES_PATH, getAsString("PROJECT_PATH")

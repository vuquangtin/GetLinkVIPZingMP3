package com.get.link.zingmp3.utilities;
...
import com.get.link.zingmp3.browser.enums.KEYS;
...
public class DriverUtils {
	...
	private WebDriver instantiateChromeDriver() {
		String driverToBeLoaded = thisRun.getAsString(KEYS.OS_NAME.toString())
				.contains("Windows") ? "chromedriver_win.exe"
				: "chromedriver_mac";

		System.setProperty("webdriver.chrome.driver",
				thisRun.getAsString(KEYS.TEST_RESOURCES.toString()) + "/"
						+ driverToBeLoaded);
	...
	private WebDriver instantiateFireFoxDriver() {
		String driverToBeLoaded = thisRun.getAsString(KEYS.OS_NAME.toString())
				.contains("Windows") ? "geckodriver_win.exe"
				: "geckodriver_mac.exe";
	...
	private DesiredCapabilities getBrowserCapabilities(String browserType) {
		...
		default:
			throw new InvalidArgumentException("browser : " + browserType
					+ " is invalid.");
		}
	}
